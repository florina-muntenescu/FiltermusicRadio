...
public class XMLParsingTest extends InstrumentationTestCase {
    ...
    private static final String XML_FEED = "<?xml version=\"1.0\" encoding=\"utf-8\" ?> <rss " +
            "version=\"2.0\" xml:base=\"http://filtermusic.net/\" xmlns:atom=\"http://www.w3" +
            ".org/2005/Atom\" xmlns:dc=\"http://purl.org/dc/elements/1.1/\"> <channel> " +
            ...
            " <enclosure url=\"http://filtermusic.net/sites/default/files/difm-house-music.jpg\" " +
            "length=\"21593\" type=\"image/jpeg\" />\n" +
            " <musicgenre>House / Dance</musicgenre>\n" +
            " <description>Silky, sexy, deep house music, straight from the heart of New York " +
            "City!</description>\n" +
            " <category>Icecast</category>\n" +
            "</item>\n" +
            " <item> <title>Insomnia fm</title>\n" +
            " <serverURL>http://208.43.9.96:8092</serverURL>\n" +
            " <enclosure url=\"http://filtermusic.net/sites/default/files/insomniafm_0.jpg\" " +
            "length=\"36246\" type=\"image/jpeg\" />\n" +

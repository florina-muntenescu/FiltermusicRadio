 ...
 */
public class RadioDetailActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(RadioDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(RadioDetailFragment.ARG_ITEM_ID));
            RadioDetailFragment fragment = new RadioDetailFragment();
            fragment.setArguments(arguments);
            getFragmentManager().beginTransaction()
                    .add(R.id.radio_detail_container, fragment)
                    .commit();
        }
    }
